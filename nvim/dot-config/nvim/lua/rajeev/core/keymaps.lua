...
keymap.set("n", "<leader>ww", "<cmd>w<CR>", {desc = "Write the whole buffer to the current file"})
keymap.set("n", "<leader>wa", "<cmd>wa<CR>", {desc = "Write all changed buffers"})
keymap.set("n", "<leader>wq", "<cmd>wqa<CR>", {desc = "Write all changed buffers and exit vim"})
keymap.set("n", "<leader>qq", "<cmd>q<CR>", {desc = "Quit the current window"})
